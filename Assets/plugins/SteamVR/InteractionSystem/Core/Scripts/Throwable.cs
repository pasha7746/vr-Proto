...
namespace Valve.VR.InteractionSystem
{
	...
	public class Throwable : MonoBehaviour
	{
		...
		[Tooltip( "How fast must this object be MovingTest to attach due to a trigger hold instead of a trigger press?" )]
		...
		private void OnHandHoverBegin( Hand hand )
		{
			...
			// Only do this if the throwable is MovingTest faster than the prescribed threshold speed,
